...
mod tests {
    ...
    fn test_generate_burn_in_tags_build_variant() {
        ...
        assert_eq!(burn_in_tags_build_variant.tasks[0].name, compile_task_group_name.to_string());
        assert_eq!(burn_in_tags_build_variant.tasks[0].distros.as_ref().unwrap()[0], compile_distro.to_string());
    }
}

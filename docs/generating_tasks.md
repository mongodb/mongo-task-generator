...
* **dependency**: Any tasks that the generated tasks should depend on in evergreen. This is typically
  things like compile or other tasks that generate artifacts needed for testing. This option can
  be specified multiple times. This defaults to `archive_dist_test_debug`.
